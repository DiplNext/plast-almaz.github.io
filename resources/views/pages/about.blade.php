...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single_team_member wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                            <div class="team_thumb">
                                <a href="#"><img src="img/others/team1.png" alt=""></a>
                                <div class="team_text">
                                    <h3>Kianna Pham</h3>
                                    <h4>Team Member</h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single_team_member wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1.2s">
                            <div class="team_thumb">
                                <a href="#"><img src="img/others/team2.png" alt=""></a>
                                <div class="team_text">
                                    <h3>Kianna Pham</h3>
                                    <h4>Team Member</h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single_team_member wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            <div class="team_thumb">
                                <a href="#"><img src="img/others/team3.png" alt=""></a>
                                <div class="team_text">
                                    <h3>Kianna Pham</h3>
                                    <h4>Team Member</h4>
                                </div>
    ...
    <div class="testimonial_section mb-110 wow fadeInUp" data-bgimg="img/others/testimonial-bg.png" data-wow-delay="0.1s"
                    ...
                    <div class="testimonial_wrapper slick__activation" data-slick='{
                        ...
                        <div class="testimonial_inner d-flex align-items-center">
                            <div class="testimonial_thumb">
                                <img src="img/others/testimonial-shap-thumb.png" alt="">
                            </div>
