...
<head>
  ...
  <script src="js/assets/modernizr-3.11.2.min.js"></script>
  <!-- Structured Data  -->
      ...
      <div class="col-12">
        <div class="main_header d-flex justify-content-between align-items-center">
          <div class="header_logo">
            <a class="sticky_none" href="index.html"><img src="img/logo/logo.png" alt=""></a>
          </div>
          <!--main menu start-->
...
<div class="hero_banner_section hero_banner2 d-flex align-items-center mb-60"
     data-bgimg="/img/bg/sliderbg.jpg">
  <div class="container">
...
{{--              <img src="img/others/services1.png" alt="">--}}
{{--            </div>--}}
...
{{--            <div class="services_thumb">--}}
{{--              <img src="img/others/services2.png" alt="">--}}
{{--            </div>--}}
{{--            <div class="services_content">--}}
...
{{--            <div class="services_thumb">--}}
{{--              <img src="img/others/services3.png" alt="">--}}
{{--            </div>--}}
{{--            <div class="services_content">--}}
...
{{--            <div class="services_thumb">--}}
{{--              <img src="img/others/services4.png" alt="">--}}
{{--            </div>--}}
{{--            <div class="services_content">--}}
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="single_banner wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
          <div class="banner_thumb">
            <a href="#"><img src="img/bg/banner1.png" alt=""></a>
      ...
      <div class="col-lg-6 col-md-6">
        <div class="single_banner wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1.2s">
          <div class="banner_thumb">
            <a href="#"><img src="img/bg/banner2.png" alt=""></a>
            <div class="banner_text">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <article class="single_product">
                <figure>
                  <div class="product_thumb">
                    <a href="single-product.html"><img src="img/product/product3.png"
                                                       alt=""></a>
                    <div class="action_links">
                      <ul class="d-flex justify-content-center">
                        <li class="add_to_cart"><a href="cart.html" title="Add to cart">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <article class="single_product">
                <figure>
                  <div class="product_thumb">
                    <a href="single-product.html"><img src="img/product/product4.png"
                                                       alt=""></a>
                    <div class="action_links">
                      <ul class="d-flex justify-content-center">
                        <li class="add_to_cart"><a href="cart.html" title="Add to cart">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <article class="single_product">
                <figure>
                  <div class="product_thumb">
                    <a href="single-product.html"><img src="img/product/product5.png"
                                                       alt=""></a>
                    <div class="action_links">
                      <ul class="d-flex justify-content-center">
                        <li class="add_to_cart"><a href="cart.html" title="Add to cart">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <article class="single_product">
                <figure>
                  <div class="product_thumb">
                    <a href="single-product.html"><img src="img/product/product6.png"
                                                       alt=""></a>
                    <div class="action_links">
                      <ul class="d-flex justify-content-center">
                        <li class="add_to_cart"><a href="cart.html" title="Add to cart">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <article class="single_product">
                <figure>
                  <div class="product_thumb">
                    <a href="single-product.html"><img src="img/product/product7.png"
                                                       alt=""></a>
                    <div class="action_links">
                      <ul class="d-flex justify-content-center">
                        <li class="add_to_cart"><a href="cart.html" title="Add to cart">
...
{{--            <a class="primary" href="#"><img src="img/others/brand1.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover1.png" alt=""></a>--}}
{{--          </div>--}}
{{--          <div class="single_brand">--}}
{{--            <a class="primary" href="#"><img src="img/others/brand2.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover2.png" alt=""></a>--}}
{{--          </div>--}}
{{--          <div class="single_brand">--}}
{{--            <a class="primary" href="#"><img src="img/others/brand3.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover3.png" alt=""></a>--}}
{{--          </div>--}}
{{--          <div class="single_brand">--}}
{{--            <a class="primary" href="#"><img src="img/others/brand4.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover4.png" alt=""></a>--}}
{{--          </div>--}}
{{--          <div class="single_brand">--}}
{{--            <a class="primary" href="#"><img src="img/others/brand5.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover5.png" alt=""></a>--}}
{{--          </div>--}}
{{--          <div class="single_brand ">--}}
{{--            <a class="primary" href="#"><img src="img/others/brand1.png" alt=""></a>--}}
{{--            <a class="secondary" href="#"><img src="img/others/brand-hover1.png" alt=""></a>--}}
...
<script src="js/assets/jquery.scrollup.min.js"></script>
<script src="js/assets/jquery.nice-select.js"></script>
<script src="js/assets/jquery.magnific-popup.min.js"></script>
<script src="js/assets/mailchimp-ajax.js"></script>
<script src="js/assets/jquery-ui.min.js"></script>
<script src="js/assets/jquery.zoom.min.js"></script>
